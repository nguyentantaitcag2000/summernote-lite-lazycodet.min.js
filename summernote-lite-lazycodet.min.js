                ...
                return (
                    ...
                    (n = [
                        ...
                        },
                        {
                            key: "createTable",
                            value: function (t, e, n) {
                                for (var o, r = [], a = 0; a < t; a++) r.push('<td class="border border-dark">' + pt.blank + "</td>");
                                o = r.join("");
                            ...
                            value: function (t) {
                                ...
                                if (n && 11 === n[1].length) {
                                    ...
                                    if (void 0 !== n[2]) {
                                        ...
                                        if (g) for (var b = [3600, 60, 1], k = 0, y = b.length; k < y; k++) v += void 0 !== g[k + 1] ? b[k] * parseInt(g[k + 1], 10) : 0;
                                    }
                                    e = i()("<iframe>")
                                        .attr("frameborder", 0)
            ...
            var s = (function () {
                function t(e, n) {
                    if (
                        ...
                        (this.$node = e),
                        (this.options = i.a.extend({}, { title: "", target: n.container, trigger: "hover focus", placement: "bottom" }, n)),
                    ...
                    (n = [
                        {
                            ...
                            value: function () {
                                ...
                                "bottom" === a
                                    ...
                                    : "right" === a && o.css({ top: e.top + (l / 2 - u / 2), left: e.left + s }),
                                    o.addClass("in");
                            },
                        },
                        {
            ...
            var h = (function () {
                ...
                C = r.a.create('<button type="button" class="note-btn" tabindex="-1">', function (t, e) {
                    e &&
                        ...
                        t.data("_lite_tooltip", new s(t, { title: e.tooltip, container: e.container })).on("click", function (t) {
                            i()(t.currentTarget).data("_lite_tooltip").hide();
                        })),
                        e.contents && t.html(e.contents),
                        e && e.data && "dropdown" === e.data.toggle && t.data("_lite_dropdown", new u(t, { container: e.container })),
                ...
                E = function (t, e) {
                    return w(
                        [
                            C({ className: "dropdown-toggle", contents: t.title + " " + z("note-icon-caret"), tooltip: t.tooltip, data: { toggle: "dropdown" } }),
                            x({ className: t.className, items: t.items, template: t.template, itemClick: t.itemClick }),
                        ],
                        { callback: e }
                    ).render();
                },
                $ = function (t, e) {
                    return w(
                        [
                            C({ className: "dropdown-toggle", contents: t.title + " " + z("note-icon-caret"), tooltip: t.tooltip, data: { toggle: "dropdown" } }),
                            S({ className: t.className, checkClassName: t.checkClassName, items: t.items, template: t.template, itemClick: t.itemClick }),
                        ],
                        { callback: e }
                    ).render();
                },
                N = function (t) {
                    return w([
                        C({ className: "dropdown-toggle", contents: t.title + " " + z("note-icon-caret"), tooltip: t.tooltip, data: { toggle: "dropdown" } }),
                        x([w({ className: "note-align", children: t.items[0] }), w({ className: "note-list", children: t.items[1] })]),
                    ]).render();
                },
                I = function (t) {
                    return w(
                ...
                P = r.a.create('<div class="note-color-palette"/>', function (t, e) {
                    ...
                    t.html(n.join("")),
                        t.find(".note-color-btn").each(function () {
                            i()(this).data("_lite_tooltip", new s(i()(this), { container: e.container }));
                        });
                }),
                R = function (t, e) {
                    return w({
                        ...
                        children: [
                            ...
                            C({ className: "dropdown-toggle", contents: z("note-icon-caret"), tooltip: t.lang.color.more, data: { toggle: "dropdown" } }),
                            x({
                                items: [
                                    "<div>",
                    ...
                    e.fade && t.addClass("fade"),
                        ...
                        t.html(
                            [
                                ...
                                e.title
                                    ? '<div class="note-modal-header"><button type="button" class="close" aria-label="Close" aria-hidden="true"><i class="note-icon-close"></i></button><h4 class="note-modal-title">' + e.title + "</h4></div>"
                                    : "",
                ...
                D = function (t) {
                    var e =
                            ...
                            (t.disableLinkTarget
                                ? ""
                                : '<div class="checkbox"><label for="note-dialog-link-nw-' + t.id + '"><input id="note-dialog-link-nw-' + t.id + '" type="checkbox" checked> ' + t.lang.link.openInNewWindow + "</label></div>") +
